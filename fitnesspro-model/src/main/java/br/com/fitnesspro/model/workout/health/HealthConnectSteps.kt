...
/**
 * Armazena um registro de contagem de passos durante um período de tempo.
 ...
 * @param count O número total de passos dados durante o período.
 * @param startTime A data/hora de início do período da contagem de passos.
 * @param endTime A data/hora de término do período da contagem de passos.
