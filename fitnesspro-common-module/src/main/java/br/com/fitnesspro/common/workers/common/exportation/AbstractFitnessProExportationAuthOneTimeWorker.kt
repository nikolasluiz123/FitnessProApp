package br.com.fitnesspro.common.workers.common.exportation

import android.content.Context
import androidx.work.WorkerParameters
import br.com.android.firebase.toolkit.crashlytics.sendToFirebaseCrashlytics
import br.com.android.work.manager.toolkit.workers.coroutine.onetime.sync.AbstractExportationTokenAuthOneTimeWorker
...
abstract class AbstractFitnessProExportationAuthOneTimeWorker(
    context: Context,
    workerParams: WorkerParameters
) : AbstractExportationTokenAuthOneTimeWorker(context, workerParams) {
