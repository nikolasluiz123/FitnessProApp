...
interface IHealthConnectIntegrationEntryPoint {
    ...
    fun getStepsMapper(): StepsMapper
    fun getCaloriesBurnedMapper(): CaloriesBurnedMapper
    fun getHeartRateMapper(): HeartRateMapper
    fun getSleepSessionMapper(): SleepSessionMapper
